...
#include "DedicatedServers/Public/Subsystems/DS_HttpRequestSubsystem.h"
...
UDSLocalPlayerSubsystem* UDS_HttpRequestSubsystem::GetDSLocalPlayerSubsystem() const
{
...
bool UDS_HttpRequestSubsystem::ContainsErrors(TSharedPtr<FJsonObject> JsonObject)
{
...
void UDS_HttpRequestSubsystem::DumpMetaData(TSharedPtr<FJsonObject> JsonObject)
{
...
FString UDS_HttpRequestSubsystem::SerializeJsonContent(const TMap<FString, FString>& Params)
{
