...
namespace NaviGameplayTags
{
	...
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SMGs_Stinger);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SMGs_Spectre);
	
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Shotguns_Bucky);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Shotguns_Judge);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Rifles_Bulldog);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Rifles_Guardian);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Rifles_Phantom);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Rifles_Vandal);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SniperRifles_Marshal);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SniperRifles_Outlaw);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_SniperRifles_Operator);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_MachineGuns_Ares);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_MachineGuns_Odin);
