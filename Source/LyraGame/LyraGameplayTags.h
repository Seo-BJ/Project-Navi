...
namespace NaviGameplayTags
{
	...
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_Classic_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_Shorty);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_Shorty_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_Frenzy);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_Frenzy_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_Ghost);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_Ghost_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_Sheriff);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_Sheriff_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_GoldenGun);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_GoldenGun_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_SnowballLauncher);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Sidearms_SnowballLauncher_Fire);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SMGs_Stinger);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SMGs_Stinger_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SMGs_Spectre);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SMGs_Spectre_Fire);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Shotguns_Bucky);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Shotguns_Bucky_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Shotguns_Judge);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Shotguns_Judge_Fire);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Rifles_Bulldog);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Rifles_Bulldog_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Rifles_Guardian);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Rifles_Guardian_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Rifles_Phantom);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Rifles_Phantom_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Rifles_Vandal);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_Rifles_Vandal_Fire);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SniperRifles_Marshal);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SniperRifles_Marshal_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SniperRifles_Outlaw);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SniperRifles_Outlaw_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SniperRifles_Operator);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_SniperRifles_Operator_Fire);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_MachineGuns_Ares);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_MachineGuns_Ares_Fire);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_MachineGuns_Odin);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Primary_MachineGuns_Odin_Fire);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Melee_Default);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon_Melee_Default_Fire);
	...
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navi_Score_Eliminations);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navi_Score_Deaths);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navi_Score_Assists);

	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Agent_Ultimate_CurrentPoint);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Agent_Ultimate_RequiredPoint);

	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navi_Spike_InPlantArea);
	
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navi_Spike_Plant_Start);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navi_Spike_Plant_Finish);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navi_Spike_Explosion);
	
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navi_Spike_Defuse_Start);
	LYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navi_Spike_Defuse_Finish);
