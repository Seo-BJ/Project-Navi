...
struct FLyraTeamChangeMessage
{
	...
	int32 OldTeamId = INDEX_NONE;

	UPROPERTY(BlueprintReadWrite, Category = "Team Message")
	int32 NewTeamId = INDEX_NONE;
};
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnLyraTeamIdChangedForBPDelegate, UObject*, ObjectChangingTeam, int32, OldTeamID, int32, NewTeamID);
...
public:
	...
	virtual void SetIndexInTeam(const int32 NewIndexInTeam);
	...
	void SetPlayerSessionId(FString NewPlayerSessionId) 
	{
...
private:
	...
	//~Lyra Team 
	UPROPERTY(ReplicatedUsing = OnRep_MyTeamID, VisibleInstanceOnly, Category = "Teams") 
	FGenericTeamId MyTeamID;

	UPROPERTY(ReplicatedUsing = OnRep_MySquadID, VisibleInstanceOnly, Category = "Teams") 
	int32 MySquadID;
	
	UPROPERTY(ReplicatedUsing = OnRep_MyIndexInTeam, VisibleInstanceOnly, Category = "Teams") 
	int32 MyIndexInTeam;
