...
#define UE_MODULE_NAME "NaviCoreRuntime"
#define UE_PLUGIN_NAME "NaviCore"
#define IMPLEMENT_ENCRYPTION_KEY_REGISTRATION() 
#define IMPLEMENT_SIGNING_KEY_REGISTRATION() 
#define NAVICORERUNTIME_API DLLEXPORT
