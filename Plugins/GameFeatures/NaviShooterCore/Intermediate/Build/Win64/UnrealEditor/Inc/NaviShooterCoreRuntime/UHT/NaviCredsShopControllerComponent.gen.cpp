...
// Begin Class UNaviCredsShopControllerComponent Function ServerRequestPurchaseWeapon
struct NaviCredsShopControllerComponent_eventServerRequestPurchaseWeapon_Parms
{
	FGameplayTag WeaponTag;
};
static const FName NAME_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon = FName(TEXT("ServerRequestPurchaseWeapon"));
void UNaviCredsShopControllerComponent::ServerRequestPurchaseWeapon(FGameplayTag WeaponTag)
{
	NaviCredsShopControllerComponent_eventServerRequestPurchaseWeapon_Parms Parms;
	Parms.WeaponTag=WeaponTag;
	UFunction* Func = FindFunctionChecked(NAME_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon);
	ProcessEvent(Func,&Parms);
}
struct Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::NewProp_WeaponTag = { "WeaponTag", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NaviCredsShopControllerComponent_eventServerRequestPurchaseWeapon_Parms, WeaponTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 1298103297
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::NewProp_WeaponTag,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNaviCredsShopControllerComponent, nullptr, "ServerRequestPurchaseWeapon", nullptr, nullptr, Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::PropPointers), sizeof(NaviCredsShopControllerComponent_eventServerRequestPurchaseWeapon_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04280CC0, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::Function_MetaDataParams) };
static_assert(sizeof(NaviCredsShopControllerComponent_eventServerRequestPurchaseWeapon_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNaviCredsShopControllerComponent::execServerRequestPurchaseWeapon)
{
	P_GET_STRUCT(FGameplayTag,Z_Param_WeaponTag);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ServerRequestPurchaseWeapon_Implementation(Z_Param_WeaponTag);
	P_NATIVE_END;
}
// End Class UNaviCredsShopControllerComponent Function ServerRequestPurchaseWeapon
...
void UNaviCredsShopControllerComponent::StaticRegisterNativesUNaviCredsShopControllerComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "ServerRequestPurchaseWeapon", &UNaviCredsShopControllerComponent::execServerRequestPurchaseWeapon },
	};
...
struct Z_Construct_UClass_UNaviCredsShopControllerComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UNaviCredsShopControllerComponent_ServerRequestPurchaseWeapon, "ServerRequestPurchaseWeapon" }, // 1469028027
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_binij_Documents_UnrealProjects_Navi_Plugins_GameFeatures_NaviShooterCore_Source_NaviShooterCoreRuntime_Public_CredsSystem_NaviCredsShopControllerComponent_h_3254550843(TEXT("/Script/NaviShooterCoreRuntime"),
